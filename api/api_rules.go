...
func (a *RulesAPIService) DeleteRuleExecute(r ApiDeleteRuleRequest) (*AsyncResponse, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "RulesAPIService.DeleteRuleExecute")
	defer span.End()
	r.ctx = ctx
	var (
...
func (a *RulesAPIService) GetRuleExecute(r ApiGetRuleRequest) (*GetRule, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "RulesAPIService.GetRuleExecute")
	defer span.End()
	r.ctx = ctx
	var (
...
func (a *RulesAPIService) GetRuleListExecute(r ApiGetRuleListRequest) (*GetRules, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "RulesAPIService.GetRuleListExecute")
	defer span.End()
	r.ctx = ctx
	var (
		localVarHTTPMethod  = http.MethodGet
...
func (a *RulesAPIService) PatchRuleExecute(r ApiPatchRuleRequest) (*AsyncResponse, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "RulesAPIService.PatchRuleExecute")
	defer span.End()
	r.ctx = ctx
	var (
...
func (a *RulesAPIService) PostRuleExecute(r ApiPostRuleRequest) (*AsyncResponse, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "RulesAPIService.PostRuleExecute")
	defer span.End()
	r.ctx = ctx
	var (
