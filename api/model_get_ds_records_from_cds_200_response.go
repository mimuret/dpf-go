...
// checks if the GetDsRecordsFromCds200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetDsRecordsFromCds200Response{}

// GetDsRecordsFromCds200Response struct for GetDsRecordsFromCds200Response
type GetDsRecordsFromCds200Response struct {
	// 処理の問い合わせの際のキーになる文字列
	RequestId string                                            `json:"request_id"`
	Results   []GetDsRecordsFromCds200ResponseAllOfResultsInner `json:"results"`
}

type _GetDsRecordsFromCds200Response GetDsRecordsFromCds200Response
...
func NewGetDsRecordsFromCds200Response(requestId string, results []GetDsRecordsFromCds200ResponseAllOfResultsInner) *GetDsRecordsFromCds200Response {
	this := GetDsRecordsFromCds200Response{}
...
func (o *GetDsRecordsFromCds200Response) GetResults() []GetDsRecordsFromCds200ResponseAllOfResultsInner {
	if o == nil {
		var ret []GetDsRecordsFromCds200ResponseAllOfResultsInner
		return ret
	}
...
func (o GetDsRecordsFromCds200Response) MarshalJSON() ([]byte, error) {
...
func (o GetDsRecordsFromCds200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetDsRecordsFromCds200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetDsRecordsFromCds200Response := _GetDsRecordsFromCds200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetDsRecordsFromCds200Response)

	if err != nil {
		return err
	}

	*o = GetDsRecordsFromCds200Response(varGetDsRecordsFromCds200Response)

	return err
}

type NullableGetDsRecordsFromCds200Response struct {
	value *GetDsRecordsFromCds200Response
	isSet bool
}

func (v NullableGetDsRecordsFromCds200Response) Get() *GetDsRecordsFromCds200Response {
	return v.value
}

func (v *NullableGetDsRecordsFromCds200Response) Set(val *GetDsRecordsFromCds200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetDsRecordsFromCds200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetDsRecordsFromCds200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetDsRecordsFromCds200Response(val *GetDsRecordsFromCds200Response) *NullableGetDsRecordsFromCds200Response {
	return &NullableGetDsRecordsFromCds200Response{value: val, isSet: true}
}

func (v NullableGetDsRecordsFromCds200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetDsRecordsFromCds200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
