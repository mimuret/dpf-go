...
func (a *ZoneProxyAPIService) GetZoneProxyHealthCheckExecute(r ApiGetZoneProxyHealthCheckRequest) (*GetZoneProxyHealth, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "ZoneProxyAPIService.GetZoneProxyHealthCheckExecute")
	defer span.End()
	r.ctx = ctx
	var (
...
func (a *ZoneProxyAPIService) GetZoneProxyListExecute(r ApiGetZoneProxyListRequest) (*GetZoneProxy, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "ZoneProxyAPIService.GetZoneProxyListExecute")
	defer span.End()
	r.ctx = ctx
	var (
		localVarHTTPMethod  = http.MethodGet
...
func (a *ZoneProxyAPIService) PatchZoneProxyExecute(r ApiPatchZoneProxyRequest) (*AsyncResponse, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "ZoneProxyAPIService.PatchZoneProxyExecute")
	defer span.End()
	r.ctx = ctx
	var (
