...
func (a *RuleMethodsAPIService) DeleteRuleMethodExecute(r ApiDeleteRuleMethodRequest) (*AsyncResponse, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "RuleMethodsAPIService.DeleteRuleMethodExecute")
	defer span.End()
	r.ctx = ctx
	var (
...
func (a *RuleMethodsAPIService) GetRuleMethodExecute(r ApiGetRuleMethodRequest) (*GetRuleMethod, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "RuleMethodsAPIService.GetRuleMethodExecute")
	defer span.End()
	r.ctx = ctx
	var (
...
func (a *RuleMethodsAPIService) GetRuleMethodListExecute(r ApiGetRuleMethodListRequest) (*GetRuleMethods, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "RuleMethodsAPIService.GetRuleMethodListExecute")
	defer span.End()
	r.ctx = ctx
	var (
		localVarHTTPMethod  = http.MethodGet
...
func (a *RuleMethodsAPIService) PatchRuleMethodExecute(r ApiPatchRuleMethodRequest) (*AsyncResponse, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "RuleMethodsAPIService.PatchRuleMethodExecute")
	defer span.End()
	r.ctx = ctx
	var (
...
func (a *RuleMethodsAPIService) PostRuleMethodExecute(r ApiPostRuleMethodRequest) (*AsyncResponse, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "RuleMethodsAPIService.PostRuleMethodExecute")
	defer span.End()
	r.ctx = ctx
	var (
