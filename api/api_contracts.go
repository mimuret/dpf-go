...
func (a *ContractsAPIService) GetContractExecute(r ApiGetContractRequest) (*GetContract, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "ContractsAPIService.GetContractExecute")
	defer span.End()
	r.ctx = ctx
	var (
...
func (r ApiGetContractLabelsRequest) Execute() (*GetContractLabels200Response, *http.Response, error) {
...
// Execute executes the request
//  @return GetContractLabels200Response
func (a *ContractsAPIService) GetContractLabelsExecute(r ApiGetContractLabelsRequest) (*GetContractLabels200Response, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "ContractsAPIService.GetContractLabelsExecute")
	defer span.End()
	r.ctx = ctx
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *GetContractLabels200Response
	)
...
func (a *ContractsAPIService) GetContractListExecute(r ApiGetContractListRequest) (*GetContracts, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "ContractsAPIService.GetContractListExecute")
	defer span.End()
	r.ctx = ctx
	var (
		localVarHTTPMethod  = http.MethodGet
	...
	if r.keywordsPlan != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "_keywords_plan[]", r.keywordsPlan, "")
	}
...
func (a *ContractsAPIService) GetContractListCountExecute(r ApiGetContractListCountRequest) (*GetCount, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "ContractsAPIService.GetContractListCountExecute")
	defer span.End()
	r.ctx = ctx
	var (
		localVarHTTPMethod  = http.MethodGet
...
func (a *ContractsAPIService) PatchContractExecute(r ApiPatchContractRequest) (*AsyncResponse, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "ContractsAPIService.PatchContractExecute")
	defer span.End()
	r.ctx = ctx
	var (
...
func (a *ContractsAPIService) PutContractLabelsExecute(r ApiPutContractLabelsRequest) (*AsyncResponse, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "ContractsAPIService.PutContractLabelsExecute")
	defer span.End()
	r.ctx = ctx
	var (
