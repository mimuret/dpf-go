...
// checks if the GetZoneLabels200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetZoneLabels200Response{}

// GetZoneLabels200Response struct for GetZoneLabels200Response
type GetZoneLabels200Response struct {
	// 処理の問い合わせの際のキーになる文字列
	RequestId string     `json:"request_id"`
	Result    ZoneLabels `json:"result"`
}

type _GetZoneLabels200Response GetZoneLabels200Response
...
func (o GetZoneLabels200Response) MarshalJSON() ([]byte, error) {
...
func (o GetZoneLabels200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetZoneLabels200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetZoneLabels200Response := _GetZoneLabels200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetZoneLabels200Response)

	if err != nil {
		return err
	}

	*o = GetZoneLabels200Response(varGetZoneLabels200Response)

	return err
}

type NullableGetZoneLabels200Response struct {
	value *GetZoneLabels200Response
	isSet bool
}

func (v NullableGetZoneLabels200Response) Get() *GetZoneLabels200Response {
	return v.value
}

func (v *NullableGetZoneLabels200Response) Set(val *GetZoneLabels200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetZoneLabels200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetZoneLabels200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetZoneLabels200Response(val *GetZoneLabels200Response) *NullableGetZoneLabels200Response {
	return &NullableGetZoneLabels200Response{value: val, isSet: true}
}

func (v NullableGetZoneLabels200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetZoneLabels200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
