...
func (a *DefaultTtlAPIService) DeleteDefaultTtlChangesExecute(r ApiDeleteDefaultTtlChangesRequest) (*AsyncResponse, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "DefaultTtlAPIService.DeleteDefaultTtlChangesExecute")
	defer span.End()
	r.ctx = ctx
	var (
...
func (a *DefaultTtlAPIService) GetDefaultTtlDiffsExecute(r ApiGetDefaultTtlDiffsRequest) (*GetDefaultTtlDiffs, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "DefaultTtlAPIService.GetDefaultTtlDiffsExecute")
	defer span.End()
	r.ctx = ctx
	var (
...
func (a *DefaultTtlAPIService) GetDefaultTtlListExecute(r ApiGetDefaultTtlListRequest) (*GetDefaultTtl, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "DefaultTtlAPIService.GetDefaultTtlListExecute")
	defer span.End()
	r.ctx = ctx
	var (
		localVarHTTPMethod  = http.MethodGet
...
func (a *DefaultTtlAPIService) PatchDefaultTtlExecute(r ApiPatchDefaultTtlRequest) (*AsyncResponse, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "DefaultTtlAPIService.PatchDefaultTtlExecute")
	defer span.End()
	r.ctx = ctx
	var (
