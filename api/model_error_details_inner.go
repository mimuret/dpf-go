...
// checks if the ErrorDetailsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorDetailsInner{}
...
func NewErrorDetailsInner() *ErrorDetailsInner {
	this := ErrorDetailsInner{}
	return &this
}

// NewErrorDetailsInnerWithDefaults instantiates a new ErrorDetailsInner object
...
func (o *ErrorDetailsInner) GetAttribute() string {
...
func (o *ErrorDetailsInner) GetAttributeOk() (*string, bool) {
	if o == nil || IsNil(o.Attribute) {
		return nil, false
	}
...
func (o *ErrorDetailsInner) HasAttribute() bool {
	if o != nil && !IsNil(o.Attribute) {
		return true
	}
...
func (o *ErrorDetailsInner) SetAttribute(v string) {
	o.Attribute = &v
}
