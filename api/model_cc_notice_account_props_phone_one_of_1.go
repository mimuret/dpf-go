...
// checks if the CcNoticeAccountPropsPhoneOneOf1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CcNoticeAccountPropsPhoneOneOf1{}

// CcNoticeAccountPropsPhoneOneOf1 struct for CcNoticeAccountPropsPhoneOneOf1
type CcNoticeAccountPropsPhoneOneOf1 struct {
	// 国番号（number指定時必須）
...
type _CcNoticeAccountPropsPhoneOneOf1 CcNoticeAccountPropsPhoneOneOf1

// NewCcNoticeAccountPropsPhoneOneOf1 instantiates a new CcNoticeAccountPropsPhoneOneOf1 object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewCcNoticeAccountPropsPhoneOneOf1(countryCode string, number string) *CcNoticeAccountPropsPhoneOneOf1 {
	this := CcNoticeAccountPropsPhoneOneOf1{}
	this.CountryCode = countryCode
	this.Number = number
	return &this
}

// NewCcNoticeAccountPropsPhoneOneOf1WithDefaults instantiates a new CcNoticeAccountPropsPhoneOneOf1 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewCcNoticeAccountPropsPhoneOneOf1WithDefaults() *CcNoticeAccountPropsPhoneOneOf1 {
	this := CcNoticeAccountPropsPhoneOneOf1{}
	return &this
}

// GetCountryCode returns the CountryCode field value
func (o *CcNoticeAccountPropsPhoneOneOf1) GetCountryCode() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *CcNoticeAccountPropsPhoneOneOf1) GetCountryCodeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CcNoticeAccountPropsPhoneOneOf1) SetCountryCode(v string) {
	o.CountryCode = v
}

// GetNumber returns the Number field value
func (o *CcNoticeAccountPropsPhoneOneOf1) GetNumber() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CcNoticeAccountPropsPhoneOneOf1) GetNumberOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CcNoticeAccountPropsPhoneOneOf1) SetNumber(v string) {
	o.Number = v
}

func (o CcNoticeAccountPropsPhoneOneOf1) MarshalJSON() ([]byte, error) {
...
func (o CcNoticeAccountPropsPhoneOneOf1) ToMap() (map[string]interface{}, error) {
...
func (o *CcNoticeAccountPropsPhoneOneOf1) UnmarshalJSON(data []byte) (err error) {
	...
	varCcNoticeAccountPropsPhoneOneOf1 := _CcNoticeAccountPropsPhoneOneOf1{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCcNoticeAccountPropsPhoneOneOf1)

	if err != nil {
		return err
	}

	*o = CcNoticeAccountPropsPhoneOneOf1(varCcNoticeAccountPropsPhoneOneOf1)

	return err
}

type NullableCcNoticeAccountPropsPhoneOneOf1 struct {
	value *CcNoticeAccountPropsPhoneOneOf1
	isSet bool
}

func (v NullableCcNoticeAccountPropsPhoneOneOf1) Get() *CcNoticeAccountPropsPhoneOneOf1 {
	return v.value
}

func (v *NullableCcNoticeAccountPropsPhoneOneOf1) Set(val *CcNoticeAccountPropsPhoneOneOf1) {
	v.value = val
	v.isSet = true
}

func (v NullableCcNoticeAccountPropsPhoneOneOf1) IsSet() bool {
	return v.isSet
}

func (v *NullableCcNoticeAccountPropsPhoneOneOf1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCcNoticeAccountPropsPhoneOneOf1(val *CcNoticeAccountPropsPhoneOneOf1) *NullableCcNoticeAccountPropsPhoneOneOf1 {
	return &NullableCcNoticeAccountPropsPhoneOneOf1{value: val, isSet: true}
}

func (v NullableCcNoticeAccountPropsPhoneOneOf1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCcNoticeAccountPropsPhoneOneOf1) UnmarshalJSON(src []byte) error {
	v.isSet = true
