...
func (a *SitesAPIService) DeleteSiteExecute(r ApiDeleteSiteRequest) (*AsyncResponse, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "SitesAPIService.DeleteSiteExecute")
	defer span.End()
	r.ctx = ctx
	var (
...
func (a *SitesAPIService) GetSiteExecute(r ApiGetSiteRequest) (*GetSite, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "SitesAPIService.GetSiteExecute")
	defer span.End()
	r.ctx = ctx
	var (
...
func (a *SitesAPIService) GetSiteListExecute(r ApiGetSiteListRequest) (*GetSites, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "SitesAPIService.GetSiteListExecute")
	defer span.End()
	r.ctx = ctx
	var (
		localVarHTTPMethod  = http.MethodGet
...
func (a *SitesAPIService) PatchSiteExecute(r ApiPatchSiteRequest) (*AsyncResponse, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "SitesAPIService.PatchSiteExecute")
	defer span.End()
	r.ctx = ctx
	var (
...
func (a *SitesAPIService) PostSiteExecute(r ApiPostSiteRequest) (*AsyncResponse, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "SitesAPIService.PostSiteExecute")
	defer span.End()
	r.ctx = ctx
	var (
