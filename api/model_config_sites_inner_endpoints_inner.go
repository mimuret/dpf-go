...
// checks if the ConfigSitesInnerEndpointsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConfigSitesInnerEndpointsInner{}

// ConfigSitesInnerEndpointsInner struct for ConfigSitesInnerEndpointsInner
type ConfigSitesInnerEndpointsInner struct {
	// コメント
	...
	Monitorings []EndpointMonitoringsMonitoringsInner `json:"monitorings"`
}

type _ConfigSitesInnerEndpointsInner ConfigSitesInnerEndpointsInner

// NewConfigSitesInnerEndpointsInner instantiates a new ConfigSitesInnerEndpointsInner object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewConfigSitesInnerEndpointsInner(description string, enabled bool, liveStatus EndpointLiveStatus, manualFailback bool, manualFailover bool, monitoringTarget string, name string, rdata []EndpointRdataInner, readyStatus EndpointReadyStatus, resourceName string, weight int32, monitorings []EndpointMonitoringsMonitoringsInner) *ConfigSitesInnerEndpointsInner {
	this := ConfigSitesInnerEndpointsInner{}
...
// NewConfigSitesInnerEndpointsInnerWithDefaults instantiates a new ConfigSitesInnerEndpointsInner object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewConfigSitesInnerEndpointsInnerWithDefaults() *ConfigSitesInnerEndpointsInner {
	this := ConfigSitesInnerEndpointsInner{}
...
func (o *ConfigSitesInnerEndpointsInner) GetDescription() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *ConfigSitesInnerEndpointsInner) GetDescriptionOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ConfigSitesInnerEndpointsInner) SetDescription(v string) {
	o.Description = v
}

// GetEnabled returns the Enabled field value
func (o *ConfigSitesInnerEndpointsInner) GetEnabled() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ConfigSitesInnerEndpointsInner) GetEnabledOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ConfigSitesInnerEndpointsInner) SetEnabled(v bool) {
	o.Enabled = v
}

// GetLiveStatus returns the LiveStatus field value
func (o *ConfigSitesInnerEndpointsInner) GetLiveStatus() EndpointLiveStatus {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *ConfigSitesInnerEndpointsInner) GetLiveStatusOk() (*EndpointLiveStatus, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ConfigSitesInnerEndpointsInner) SetLiveStatus(v EndpointLiveStatus) {
	o.LiveStatus = v
}

// GetManualFailback returns the ManualFailback field value
func (o *ConfigSitesInnerEndpointsInner) GetManualFailback() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ConfigSitesInnerEndpointsInner) GetManualFailbackOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ConfigSitesInnerEndpointsInner) SetManualFailback(v bool) {
	o.ManualFailback = v
}

// GetManualFailover returns the ManualFailover field value
func (o *ConfigSitesInnerEndpointsInner) GetManualFailover() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ConfigSitesInnerEndpointsInner) GetManualFailoverOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ConfigSitesInnerEndpointsInner) SetManualFailover(v bool) {
	o.ManualFailover = v
}

// GetMonitoringTarget returns the MonitoringTarget field value
func (o *ConfigSitesInnerEndpointsInner) GetMonitoringTarget() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ConfigSitesInnerEndpointsInner) GetMonitoringTargetOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ConfigSitesInnerEndpointsInner) SetMonitoringTarget(v string) {
	o.MonitoringTarget = v
}

// GetName returns the Name field value
func (o *ConfigSitesInnerEndpointsInner) GetName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ConfigSitesInnerEndpointsInner) GetNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Name, true
...
func (o *ConfigSitesInnerEndpointsInner) SetName(v string) {
	o.Name = v
}

// GetRdata returns the Rdata field value
func (o *ConfigSitesInnerEndpointsInner) GetRdata() []EndpointRdataInner {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *ConfigSitesInnerEndpointsInner) GetRdataOk() ([]EndpointRdataInner, bool) {
	if o == nil {
		return nil, false
	}
	return o.Rdata, true
...
func (o *ConfigSitesInnerEndpointsInner) SetRdata(v []EndpointRdataInner) {
	o.Rdata = v
}

// GetReadyStatus returns the ReadyStatus field value
func (o *ConfigSitesInnerEndpointsInner) GetReadyStatus() EndpointReadyStatus {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *ConfigSitesInnerEndpointsInner) GetReadyStatusOk() (*EndpointReadyStatus, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ConfigSitesInnerEndpointsInner) SetReadyStatus(v EndpointReadyStatus) {
	o.ReadyStatus = v
}

// GetResourceName returns the ResourceName field value
func (o *ConfigSitesInnerEndpointsInner) GetResourceName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ConfigSitesInnerEndpointsInner) GetResourceNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ConfigSitesInnerEndpointsInner) SetResourceName(v string) {
	o.ResourceName = v
}

// GetWeight returns the Weight field value
func (o *ConfigSitesInnerEndpointsInner) GetWeight() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ConfigSitesInnerEndpointsInner) GetWeightOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ConfigSitesInnerEndpointsInner) SetWeight(v int32) {
	o.Weight = v
}

// GetMonitorings returns the Monitorings field value
func (o *ConfigSitesInnerEndpointsInner) GetMonitorings() []EndpointMonitoringsMonitoringsInner {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *ConfigSitesInnerEndpointsInner) GetMonitoringsOk() ([]EndpointMonitoringsMonitoringsInner, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ConfigSitesInnerEndpointsInner) SetMonitorings(v []EndpointMonitoringsMonitoringsInner) {
	o.Monitorings = v
}

func (o ConfigSitesInnerEndpointsInner) MarshalJSON() ([]byte, error) {
...
func (o ConfigSitesInnerEndpointsInner) ToMap() (map[string]interface{}, error) {
...
func (o *ConfigSitesInnerEndpointsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varConfigSitesInnerEndpointsInner := _ConfigSitesInnerEndpointsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varConfigSitesInnerEndpointsInner)

	if err != nil {
		return err
	}

	*o = ConfigSitesInnerEndpointsInner(varConfigSitesInnerEndpointsInner)

	return err
}

type NullableConfigSitesInnerEndpointsInner struct {
	value *ConfigSitesInnerEndpointsInner
	isSet bool
}

func (v NullableConfigSitesInnerEndpointsInner) Get() *ConfigSitesInnerEndpointsInner {
	return v.value
}

func (v *NullableConfigSitesInnerEndpointsInner) Set(val *ConfigSitesInnerEndpointsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableConfigSitesInnerEndpointsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableConfigSitesInnerEndpointsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConfigSitesInnerEndpointsInner(val *ConfigSitesInnerEndpointsInner) *NullableConfigSitesInnerEndpointsInner {
	return &NullableConfigSitesInnerEndpointsInner{value: val, isSet: true}
}

func (v NullableConfigSitesInnerEndpointsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConfigSitesInnerEndpointsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
