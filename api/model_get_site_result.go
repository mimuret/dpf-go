...
// checks if the GetSiteResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetSiteResult{}

// GetSiteResult struct for GetSiteResult
...
type _GetSiteResult GetSiteResult

// NewGetSiteResult instantiates a new GetSiteResult object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGetSiteResult(description string, liveStatus SiteLiveStatus, name string, resourceName string, rrtype SiteRrtype, endpoints []Endpoint) *GetSiteResult {
	this := GetSiteResult{}
...
// NewGetSiteResultWithDefaults instantiates a new GetSiteResult object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewGetSiteResultWithDefaults() *GetSiteResult {
	this := GetSiteResult{}
...
func (o *GetSiteResult) GetDescription() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *GetSiteResult) GetDescriptionOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetSiteResult) SetDescription(v string) {
	o.Description = v
}

// GetLiveStatus returns the LiveStatus field value
func (o *GetSiteResult) GetLiveStatus() SiteLiveStatus {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *GetSiteResult) GetLiveStatusOk() (*SiteLiveStatus, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetSiteResult) SetLiveStatus(v SiteLiveStatus) {
	o.LiveStatus = v
}

// GetName returns the Name field value
func (o *GetSiteResult) GetName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *GetSiteResult) GetNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Name, true
...
func (o *GetSiteResult) SetName(v string) {
	o.Name = v
}

// GetResourceName returns the ResourceName field value
func (o *GetSiteResult) GetResourceName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *GetSiteResult) GetResourceNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetSiteResult) SetResourceName(v string) {
	o.ResourceName = v
}

// GetRrtype returns the Rrtype field value
func (o *GetSiteResult) GetRrtype() SiteRrtype {
	if o == nil {
		var ret SiteRrtype
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *GetSiteResult) GetRrtypeOk() (*SiteRrtype, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetSiteResult) SetRrtype(v SiteRrtype) {
	o.Rrtype = v
}

// GetEndpoints returns the Endpoints field value
func (o *GetSiteResult) GetEndpoints() []Endpoint {
	if o == nil {
		var ret []Endpoint
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *GetSiteResult) GetEndpointsOk() ([]Endpoint, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetSiteResult) SetEndpoints(v []Endpoint) {
	o.Endpoints = v
}

func (o GetSiteResult) MarshalJSON() ([]byte, error) {
...
func (o GetSiteResult) ToMap() (map[string]interface{}, error) {
...
func (o *GetSiteResult) UnmarshalJSON(data []byte) (err error) {
	...
	varGetSiteResult := _GetSiteResult{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetSiteResult)

	if err != nil {
		return err
	}

	*o = GetSiteResult(varGetSiteResult)

	return err
}

type NullableGetSiteResult struct {
	value *GetSiteResult
	isSet bool
}

func (v NullableGetSiteResult) Get() *GetSiteResult {
	return v.value
}

func (v *NullableGetSiteResult) Set(val *GetSiteResult) {
	v.value = val
	v.isSet = true
}

func (v NullableGetSiteResult) IsSet() bool {
	return v.isSet
}

func (v *NullableGetSiteResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetSiteResult(val *GetSiteResult) *NullableGetSiteResult {
	return &NullableGetSiteResult{value: val, isSet: true}
}

func (v NullableGetSiteResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetSiteResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
