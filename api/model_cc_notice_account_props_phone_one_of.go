...
// checks if the CcNoticeAccountPropsPhoneOneOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CcNoticeAccountPropsPhoneOneOf{}

// CcNoticeAccountPropsPhoneOneOf struct for CcNoticeAccountPropsPhoneOneOf
type CcNoticeAccountPropsPhoneOneOf struct {
	// 国番号（電話番号空の場合)
...
type _CcNoticeAccountPropsPhoneOneOf CcNoticeAccountPropsPhoneOneOf

// NewCcNoticeAccountPropsPhoneOneOf instantiates a new CcNoticeAccountPropsPhoneOneOf object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewCcNoticeAccountPropsPhoneOneOf(countryCode string, number string) *CcNoticeAccountPropsPhoneOneOf {
	this := CcNoticeAccountPropsPhoneOneOf{}
	this.CountryCode = countryCode
	this.Number = number
	return &this
}

// NewCcNoticeAccountPropsPhoneOneOfWithDefaults instantiates a new CcNoticeAccountPropsPhoneOneOf object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewCcNoticeAccountPropsPhoneOneOfWithDefaults() *CcNoticeAccountPropsPhoneOneOf {
	this := CcNoticeAccountPropsPhoneOneOf{}
	return &this
}

// GetCountryCode returns the CountryCode field value
func (o *CcNoticeAccountPropsPhoneOneOf) GetCountryCode() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *CcNoticeAccountPropsPhoneOneOf) GetCountryCodeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CcNoticeAccountPropsPhoneOneOf) SetCountryCode(v string) {
	o.CountryCode = v
}

// GetNumber returns the Number field value
func (o *CcNoticeAccountPropsPhoneOneOf) GetNumber() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CcNoticeAccountPropsPhoneOneOf) GetNumberOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CcNoticeAccountPropsPhoneOneOf) SetNumber(v string) {
	o.Number = v
}

func (o CcNoticeAccountPropsPhoneOneOf) MarshalJSON() ([]byte, error) {
...
func (o CcNoticeAccountPropsPhoneOneOf) ToMap() (map[string]interface{}, error) {
...
func (o *CcNoticeAccountPropsPhoneOneOf) UnmarshalJSON(data []byte) (err error) {
	...
	varCcNoticeAccountPropsPhoneOneOf := _CcNoticeAccountPropsPhoneOneOf{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCcNoticeAccountPropsPhoneOneOf)

	if err != nil {
		return err
	}

	*o = CcNoticeAccountPropsPhoneOneOf(varCcNoticeAccountPropsPhoneOneOf)

	return err
}

type NullableCcNoticeAccountPropsPhoneOneOf struct {
	value *CcNoticeAccountPropsPhoneOneOf
	isSet bool
}

func (v NullableCcNoticeAccountPropsPhoneOneOf) Get() *CcNoticeAccountPropsPhoneOneOf {
	return v.value
}

func (v *NullableCcNoticeAccountPropsPhoneOneOf) Set(val *CcNoticeAccountPropsPhoneOneOf) {
	v.value = val
	v.isSet = true
}

func (v NullableCcNoticeAccountPropsPhoneOneOf) IsSet() bool {
	return v.isSet
}

func (v *NullableCcNoticeAccountPropsPhoneOneOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCcNoticeAccountPropsPhoneOneOf(val *CcNoticeAccountPropsPhoneOneOf) *NullableCcNoticeAccountPropsPhoneOneOf {
	return &NullableCcNoticeAccountPropsPhoneOneOf{value: val, isSet: true}
}

func (v NullableCcNoticeAccountPropsPhoneOneOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCcNoticeAccountPropsPhoneOneOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
