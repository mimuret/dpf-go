...
func (a *LogsContractsAPIService) GetContractsLogListExecute(r ApiGetContractsLogListRequest) (*GetContractsLogs, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "LogsContractsAPIService.GetContractsLogListExecute")
	defer span.End()
	r.ctx = ctx
	var (
	...
	if r.keywordsLogType != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "_keywords_log_type[]", r.keywordsLogType, "")
	}
	...
	if r.keywordsOperation != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "_keywords_operation[]", r.keywordsOperation, "")
	}
	...
	if r.keywordsStatus != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "_keywords_status[]", r.keywordsStatus, "")
	}
...
func (a *LogsContractsAPIService) GetContractsLogListCountExecute(r ApiGetContractsLogListCountRequest) (*GetCount, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "LogsContractsAPIService.GetContractsLogListCountExecute")
	defer span.End()
	r.ctx = ctx
	var (
		localVarHTTPMethod  = http.MethodGet
