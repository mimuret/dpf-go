...
func (a *CcPrimariesAPIService) DeleteCcPrimaryExecute(r ApiDeleteCcPrimaryRequest) (*AsyncResponse, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "CcPrimariesAPIService.DeleteCcPrimaryExecute")
	defer span.End()
	r.ctx = ctx
	var (
...
func (a *CcPrimariesAPIService) GetCcPrimaryExecute(r ApiGetCcPrimaryRequest) (*GetCcPrimary, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "CcPrimariesAPIService.GetCcPrimaryExecute")
	defer span.End()
	r.ctx = ctx
	var (
...
func (a *CcPrimariesAPIService) GetCcPrimaryListExecute(r ApiGetCcPrimaryListRequest) (*GetCcPrimaries, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "CcPrimariesAPIService.GetCcPrimaryListExecute")
	defer span.End()
	r.ctx = ctx
	var (
		localVarHTTPMethod  = http.MethodGet
...
func (a *CcPrimariesAPIService) PatchCcPrimaryExecute(r ApiPatchCcPrimaryRequest) (*AsyncResponse, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "CcPrimariesAPIService.PatchCcPrimaryExecute")
	defer span.End()
	r.ctx = ctx
	var (
...
func (a *CcPrimariesAPIService) PostCcPrimaryExecute(r ApiPostCcPrimaryRequest) (*AsyncResponse, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "CcPrimariesAPIService.PostCcPrimaryExecute")
	defer span.End()
	r.ctx = ctx
	var (
