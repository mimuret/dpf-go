...
// checks if the GetContractLabels200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetContractLabels200Response{}

// GetContractLabels200Response struct for GetContractLabels200Response
type GetContractLabels200Response struct {
	// 処理の問い合わせの際のキーになる文字列
	RequestId string         `json:"request_id"`
	Result    ContractLabels `json:"result"`
}

type _GetContractLabels200Response GetContractLabels200Response
...
func NewGetContractLabels200Response(requestId string, result ContractLabels) *GetContractLabels200Response {
	this := GetContractLabels200Response{}
...
func (o GetContractLabels200Response) MarshalJSON() ([]byte, error) {
...
func (o GetContractLabels200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetContractLabels200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetContractLabels200Response := _GetContractLabels200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetContractLabels200Response)

	if err != nil {
		return err
	}

	*o = GetContractLabels200Response(varGetContractLabels200Response)

	return err
}

type NullableGetContractLabels200Response struct {
	value *GetContractLabels200Response
	isSet bool
}

func (v NullableGetContractLabels200Response) Get() *GetContractLabels200Response {
	return v.value
}

func (v *NullableGetContractLabels200Response) Set(val *GetContractLabels200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetContractLabels200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetContractLabels200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetContractLabels200Response(val *GetContractLabels200Response) *NullableGetContractLabels200Response {
	return &NullableGetContractLabels200Response{value: val, isSet: true}
}

func (v NullableGetContractLabels200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetContractLabels200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
