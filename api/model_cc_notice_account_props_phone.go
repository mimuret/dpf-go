...
func (dst *CcNoticeAccountPropsPhone) UnmarshalJSON(data []byte) error {
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data failed to match schemas in oneOf(CcNoticeAccountPropsPhone)")
	}
}
...
func (obj *CcNoticeAccountPropsPhone) GetActualInstance() interface{} {
	if obj == nil {
		return nil
	}
...
type NullableCcNoticeAccountPropsPhone struct {
	value *CcNoticeAccountPropsPhone
	isSet bool
}

func (v NullableCcNoticeAccountPropsPhone) Get() *CcNoticeAccountPropsPhone {
	return v.value
}

func (v *NullableCcNoticeAccountPropsPhone) Set(val *CcNoticeAccountPropsPhone) {
	v.value = val
	v.isSet = true
}

func (v NullableCcNoticeAccountPropsPhone) IsSet() bool {
	return v.isSet
}

func (v *NullableCcNoticeAccountPropsPhone) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCcNoticeAccountPropsPhone(val *CcNoticeAccountPropsPhone) *NullableCcNoticeAccountPropsPhone {
	return &NullableCcNoticeAccountPropsPhone{value: val, isSet: true}
}

func (v NullableCcNoticeAccountPropsPhone) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCcNoticeAccountPropsPhone) UnmarshalJSON(src []byte) error {
	v.isSet = true
