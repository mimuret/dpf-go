...
func NewSitesSitesInner(description string, endpoints []Endpoint, liveStatus SiteLiveStatus, name string, resourceName string, rrtype SiteRrtype) *SitesSitesInner {
