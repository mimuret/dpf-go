...
// checks if the TargetBadRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TargetBadRequest{}
...
func (o *TargetBadRequest) GetErrorDetails() []TargetErrorDetailsInner {
	if o == nil {
		var ret []TargetErrorDetailsInner
		return ret
	}
...
func (o *TargetBadRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varTargetBadRequest := _TargetBadRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTargetBadRequest)

	if err != nil {
		return err
	}

	*o = TargetBadRequest(varTargetBadRequest)

	return err
}

type NullableTargetBadRequest struct {
	value *TargetBadRequest
	isSet bool
}

func (v NullableTargetBadRequest) Get() *TargetBadRequest {
	return v.value
}

func (v *NullableTargetBadRequest) Set(val *TargetBadRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableTargetBadRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableTargetBadRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTargetBadRequest(val *TargetBadRequest) *NullableTargetBadRequest {
	return &NullableTargetBadRequest{value: val, isSet: true}
}

func (v NullableTargetBadRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTargetBadRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
