...
// checks if the TargetErrorDetailsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TargetErrorDetailsInner{}

// TargetErrorDetailsInner struct for TargetErrorDetailsInner
type TargetErrorDetailsInner struct {
	Code      *string `json:"code,omitempty"`
	Attribute *string `json:"attribute,omitempty"`
	Target    *string `json:"target,omitempty"`
}

// NewTargetErrorDetailsInner instantiates a new TargetErrorDetailsInner object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewTargetErrorDetailsInner() *TargetErrorDetailsInner {
	this := TargetErrorDetailsInner{}
	return &this
}

// NewTargetErrorDetailsInnerWithDefaults instantiates a new TargetErrorDetailsInner object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewTargetErrorDetailsInnerWithDefaults() *TargetErrorDetailsInner {
	this := TargetErrorDetailsInner{}
	return &this
}

// GetCode returns the Code field value if set, zero value otherwise.
func (o *TargetErrorDetailsInner) GetCode() string {
...
func (o *TargetErrorDetailsInner) GetCodeOk() (*string, bool) {
	if o == nil || IsNil(o.Code) {
		return nil, false
	}
	return o.Code, true
...
func (o *TargetErrorDetailsInner) HasCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *TargetErrorDetailsInner) SetCode(v string) {
	o.Code = &v
}

// GetAttribute returns the Attribute field value if set, zero value otherwise.
func (o *TargetErrorDetailsInner) GetAttribute() string {
...
// and a boolean to check if the value has been set.
func (o *TargetErrorDetailsInner) GetAttributeOk() (*string, bool) {
	if o == nil || IsNil(o.Attribute) {
		return nil, false
	}
...
func (o *TargetErrorDetailsInner) HasAttribute() bool {
	if o != nil && !IsNil(o.Attribute) {
		return true
	}
...
func (o *TargetErrorDetailsInner) SetAttribute(v string) {
	o.Attribute = &v
}

// GetTarget returns the Target field value if set, zero value otherwise.
func (o *TargetErrorDetailsInner) GetTarget() string {
...
// and a boolean to check if the value has been set.
func (o *TargetErrorDetailsInner) GetTargetOk() (*string, bool) {
	if o == nil || IsNil(o.Target) {
		return nil, false
	}
...
func (o *TargetErrorDetailsInner) HasTarget() bool {
	if o != nil && !IsNil(o.Target) {
		return true
	}
...
func (o *TargetErrorDetailsInner) SetTarget(v string) {
	o.Target = &v
}

func (o TargetErrorDetailsInner) MarshalJSON() ([]byte, error) {
...
func (o TargetErrorDetailsInner) ToMap() (map[string]interface{}, error) {
...
type NullableTargetErrorDetailsInner struct {
	value *TargetErrorDetailsInner
	isSet bool
}

func (v NullableTargetErrorDetailsInner) Get() *TargetErrorDetailsInner {
	return v.value
}

func (v *NullableTargetErrorDetailsInner) Set(val *TargetErrorDetailsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableTargetErrorDetailsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableTargetErrorDetailsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTargetErrorDetailsInner(val *TargetErrorDetailsInner) *NullableTargetErrorDetailsInner {
	return &NullableTargetErrorDetailsInner{value: val, isSet: true}
}

func (v NullableTargetErrorDetailsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTargetErrorDetailsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
