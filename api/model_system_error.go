...
func NewSystemError(errorDetails []ErrorDetailsInner, errorMessage string, errorType string, requestId string) *SystemError {
	this := SystemError{}
...
func (o *SystemError) GetErrorDetails() []ErrorDetailsInner {
	if o == nil {
...
func (o *SystemError) GetErrorDetailsOk() ([]ErrorDetailsInner, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *SystemError) SetErrorDetails(v []ErrorDetailsInner) {
	o.ErrorDetails = v
}
