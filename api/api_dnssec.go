...
func (a *DnssecAPIService) GetDnssecListExecute(r ApiGetDnssecListRequest) (*GetDnssec, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "DnssecAPIService.GetDnssecListExecute")
	defer span.End()
	r.ctx = ctx
	var (
...
func (a *DnssecAPIService) PatchDnssecExecute(r ApiPatchDnssecRequest) (*AsyncResponse, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "DnssecAPIService.PatchDnssecExecute")
	defer span.End()
	r.ctx = ctx
	var (
...
func (a *DnssecAPIService) PatchDnssecKskRolloverExecute(r ApiPatchDnssecKskRolloverRequest) (*AsyncResponse, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "DnssecAPIService.PatchDnssecKskRolloverExecute")
	defer span.End()
	r.ctx = ctx
	var (
		localVarHTTPMethod  = http.MethodPatch
