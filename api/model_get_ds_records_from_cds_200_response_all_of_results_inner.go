...
// checks if the GetDsRecordsFromCds200ResponseAllOfResultsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetDsRecordsFromCds200ResponseAllOfResultsInner{}

// GetDsRecordsFromCds200ResponseAllOfResultsInner struct for GetDsRecordsFromCds200ResponseAllOfResultsInner
...
func (o *GetDsRecordsFromCds200ResponseAllOfResultsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varGetDsRecordsFromCds200ResponseAllOfResultsInner := _GetDsRecordsFromCds200ResponseAllOfResultsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetDsRecordsFromCds200ResponseAllOfResultsInner)

	if err != nil {
		return err
	}

	*o = GetDsRecordsFromCds200ResponseAllOfResultsInner(varGetDsRecordsFromCds200ResponseAllOfResultsInner)

	return err
}

type NullableGetDsRecordsFromCds200ResponseAllOfResultsInner struct {
	value *GetDsRecordsFromCds200ResponseAllOfResultsInner
	isSet bool
}

func (v NullableGetDsRecordsFromCds200ResponseAllOfResultsInner) Get() *GetDsRecordsFromCds200ResponseAllOfResultsInner {
	return v.value
}

func (v *NullableGetDsRecordsFromCds200ResponseAllOfResultsInner) Set(val *GetDsRecordsFromCds200ResponseAllOfResultsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetDsRecordsFromCds200ResponseAllOfResultsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetDsRecordsFromCds200ResponseAllOfResultsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetDsRecordsFromCds200ResponseAllOfResultsInner(val *GetDsRecordsFromCds200ResponseAllOfResultsInner) *NullableGetDsRecordsFromCds200ResponseAllOfResultsInner {
	return &NullableGetDsRecordsFromCds200ResponseAllOfResultsInner{value: val, isSet: true}
}

func (v NullableGetDsRecordsFromCds200ResponseAllOfResultsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetDsRecordsFromCds200ResponseAllOfResultsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
