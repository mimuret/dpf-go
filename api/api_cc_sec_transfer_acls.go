...
func (a *CcSecTransferAclsAPIService) DeleteCcSecTransferAclExecute(r ApiDeleteCcSecTransferAclRequest) (*AsyncResponse, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "CcSecTransferAclsAPIService.DeleteCcSecTransferAclExecute")
	defer span.End()
	r.ctx = ctx
	var (
...
func (a *CcSecTransferAclsAPIService) GetCcSecTransferAclExecute(r ApiGetCcSecTransferAclRequest) (*GetCcSecTransferAcl, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "CcSecTransferAclsAPIService.GetCcSecTransferAclExecute")
	defer span.End()
	r.ctx = ctx
	var (
...
func (a *CcSecTransferAclsAPIService) GetCcSecTransferAclListExecute(r ApiGetCcSecTransferAclListRequest) (*GetCcSecTransferAcls, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "CcSecTransferAclsAPIService.GetCcSecTransferAclListExecute")
	defer span.End()
	r.ctx = ctx
	var (
		localVarHTTPMethod  = http.MethodGet
...
func (a *CcSecTransferAclsAPIService) PatchCcSecTransferAclExecute(r ApiPatchCcSecTransferAclRequest) (*AsyncResponse, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "CcSecTransferAclsAPIService.PatchCcSecTransferAclExecute")
	defer span.End()
	r.ctx = ctx
	var (
...
func (a *CcSecTransferAclsAPIService) PostCcSecTransferAclExecute(r ApiPostCcSecTransferAclRequest) (*AsyncResponse, *http.Response, error) {
	ctx, span := a.client.tracer.Start(r.ctx, "CcSecTransferAclsAPIService.PostCcSecTransferAclExecute")
	defer span.End()
	r.ctx = ctx
	var (
