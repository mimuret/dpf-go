...
func NewPutConfigMonitoringsInner(description string, mtype MonitoringMtype, name string, props PutConfigMonitoringsInnerProps, resourceName string) *PutConfigMonitoringsInner {
